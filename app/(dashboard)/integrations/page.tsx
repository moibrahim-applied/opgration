      ...
      <div className="border-b bg-card relative overflow-hidden">
        ...
        <div className="px-8 py-16 max-w-7xl mx-auto text-center relative z-10">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Optimizeee your workflows with these top software integrations. Seamlessly move and transform data between different apps with Opgration.
          </p>
        </div>
      </div>
                ...
                <div className="grid grid-cols-3 gap-5">
                  {filteredIntegrations.map((integration) => {
                    ...
                    return (
                      <button
                        key={integration.id}
                        onClick={() => window.location.href = `/integrations/${integration.slug}`}
